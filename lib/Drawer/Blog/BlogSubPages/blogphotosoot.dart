...
class BlogPhotosootSubPage extends StatefulWidget {
  const BlogPhotosootSubPage({super.key});

  @override
  State<BlogPhotosootSubPage> createState() => _BlogPhotosootSubPageState();
}

class _BlogPhotosootSubPageState extends State<BlogPhotosootSubPage> {
  @override
