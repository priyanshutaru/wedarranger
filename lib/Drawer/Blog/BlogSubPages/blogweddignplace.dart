...
class BlogWeddingPlaceSubPage extends StatefulWidget {
  const BlogWeddingPlaceSubPage({super.key});

  @override
  State<BlogWeddingPlaceSubPage> createState() =>
      _BlogWeddingPlaceSubPageState();
}

class _BlogWeddingPlaceSubPageState extends State<BlogWeddingPlaceSubPage> {
  @override
